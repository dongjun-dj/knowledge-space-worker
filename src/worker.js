...
const DEFAULT_SYSTEM_PROMPT = (
  ...
  + "你的目标是帮助我以后快速回忆、筛选、检索和复用这条信息，不是写长文章。\n\n"
  + "## 输出格式\n"
  + "只输出 JSON，不输出 Markdown、解释或代码块。\n"
  + "JSON 只包含这些字段：title, summary, key_points, category, tags, entities。\n\n"
  + "## 规则\n"
  + "1.所有字段内容用中文（技术术语、产品名保留英文）\n"
  + "2.summary 不整段抄原文，用中文概括，包含三部分：①这条内容讲什么主题 ②核心判断或核心方法是什么 ③对我的工作/客户/方案有什么用或怎么复用\n"
  + "3.summary 普通内容 120-220 字，高价值内容 220-350 字，最长不超过 500 字\n"
  + "4.key_points 是字符串数组（不是 markdown 列表），至少 2 条最多 3 条，绝对不能复制原文句子，必须是提炼后的结论、判断或价值\n"
  + "5.category 从以下分类中选一个：AI技术、云计算与基础设施、软件工程、数据与安全、其他技术、行业研究、商业与金融、效率工具、个人成长、社会与历史、生活、其他\n"
  + "6.tags 从以下标签池中选 3-6 个：大模型、AI Agent、RAG、企业知识库、AI工作流、AI Coding、AI Infra、模型训练、模型推理、多模态、Prompt工程、模型评测、AI应用落地、私有化部署、云计算、云原生、虚拟化、容器、分布式存储、网络架构、高可用、性能优化、软件架构、API集成、自动化脚本、DevOps、开发范式、工程效率、数据治理、数据分析、数据库、大数据、数据隐私、网络安全、身份权限、行业趋势、企业数字化、制造业、智能制造、供应链、港口物流、汽车产业、出海全球化、信创、商业模式、产品策略、客户需求、解决方案、销售方法、竞品分析、项目管理、ROI分析、股票投资、房地产、宏观经济、货币政策、资本市场、行业轮动、国际局势、科技政策、产业政策、历史、个人知识管理、办公自动化、工作流自动化、信息检索、写作表达、学习方法、思维模型、职业发展、菜谱、美食、旅行、健康、运动、家居、其他\n"
  + "7.entities 识别具体的公司、产品、工具、人物、技术术语，多个用逗号分隔\n"
  + "8.如果输入是视频字幕（通常没有标点、按句断开），先在脑海中理解完整叙事再提炼核心观点，不要被逐句碎片干扰\n"
);
...
const DEFAULT_USER_TEMPLATE = (
  ...
  + '  "summary": "中文摘要",\n'
  + '  "key_points": ["提炼后的要点1", "提炼后的要点2"],\n'
  + '  "category": "从分类中选一个",\n'
  + '  "tags": ["从标签池选3-6个"],\n'
  + '  "entities": "公司、产品、工具、人物、技术术语"\n'
  + "}\n\n"
  + "只输出 JSON，不要其他任何内容。"
);

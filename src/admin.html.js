      ...
      <div class="card rounded-lg p-4 space-y-4">
        <div>
          ...
          <div class="text-xs text-gray-500 space-y-1.5">
            ...
            <p>⑥ 请求体改为 JSON，填入：<code class="bg-gray-800 px-1.5 py-0.5 rounded text-indigo-400">{"url":"[[剪贴板]]"}</code> <span class="text-gray-600">（请求体选 JSON 后，点下方的 <b>文本</b> 类型，填入 <code class="bg-gray-800 px-1 rounded text-indigo-400">{"url":"[[剪贴板]]"}</code>，类型不要选数字/数组/字典/布尔值）</span></p>

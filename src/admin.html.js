      ...
      <div class="card rounded-lg p-4 space-y-4">
        <div>
          ...
          <div class="text-xs text-gray-500 space-y-1.5">
            ...
            <p>⑥ 请求体改为 JSON，填入：<code class="bg-gray-800 px-1.5 py-0.5 rounded text-indigo-400">{"url":"[[剪贴板]]"}</code> <span class="text-gray-600">（请求体选 JSON 后，下面会显示「键」和「文本」两个输入框，<b>键</b> 填 <code class="bg-gray-800 px-1 rounded text-indigo-400">url</code>，<b>文本</b> 填 <code class="bg-gray-800 px-1 rounded text-indigo-400">[[剪贴板]]</code>，即 {"url":"[[剪贴板]]"}）</span></p>
